...
<head>
  ...
  <!-- Global site tag (gtag.js) - Google AdWords: 850900893 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-850900893"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-850900893');
</script>
